...
**
** Created: Sat Jan 22 18:54:54 2011
...
int Protocol::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: s_MessageReady((*reinterpret_cast< quint32*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void Protocol::s_MessageReady(quint32 * _t1)
{
